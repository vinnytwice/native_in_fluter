...
//  Runner
//
//  Created by Vincenzo Calia on 29/01/24.
//
...
class MapScreen: MKMapView, UIGestureRecognizerDelegate {
...
//                setCenterCoordinateWithAltitude(centerCoordinate: centerCoordinate, zoomLevel: 3, animated: false)
//                mapContainerView = self.findViewOfType("MKScrollContainerView", inView: self)
//            } else {
//                setCenterCoordinateRegion(centerCoordinate: centerCoordinate, zoomLevel: 3, animated: false)
//            }
        }
